...
class RecipeView extends View {
  ...
  _errorMessage = 'We could not find your recipe. Please choose another one!';
  _message;
  ...
  _generateMarkupIngredients(ings) {
    return ings.reduce(
      (acc, item) =>
        acc +
        `<li class="recipe__ingredient">
              ...
              <div class="recipe__quantity">${
                item.quantity ? new Fraction(item.quantity).toString() : 0
              }</div>
